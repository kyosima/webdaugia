    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-7">
                ...
                <div class="filter__item">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <b class="text-light">Các sản phẩm đang đấu giá bạn yêu thích</b>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="filter__found">
                                <h6><span>{{count($campaign_detail_wishlist)}}</span> sản phẩm</h6>
                            </div>
                        </div>
                ...
                <div class="row">
                    @foreach($campaign_detail_wishlist as $item)
                            @include('public.campaign.include.wishlist_grid',['item'=>$item->campaign_detail()->first()->product()->first(), 'detail'=>$item->campaign_detail()->first(),'campaign'=>$item->campaign_detail()->first()->campaign()->first()])
                    @endforeach
                </div>
                <div class="product__pagination text-center">
                    {{ $campaign_detail_wishlist->links() }}
                </div>
            </div>
        </div>
    </div>
